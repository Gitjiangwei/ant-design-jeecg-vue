          ...
          <a-row type="flex" style="margin-bottom:10px" :gutter="16" v-for="(item, index) in queryParamsModel" :key="index">
            <a-col :span="6">
              <a-select  placeholder="选择查询字段" v-model="item.field">
                <a-select-option value="prj_item_num">工程编号</a-select-option>
                <a-select-option value="person_in_charge">负责人</a-select-option>
                <a-select-option value="progress_of_item">工程进度</a-select-option>
                <a-select-option value="entry_time">进场时间</a-select-option>
