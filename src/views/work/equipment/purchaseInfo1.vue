...
<script>
    import ProjectItemModal from '../project/modules/ProjectItemModel'
    import ProjectItemFileDetail from '../project/modules/ProjectItemFileDetail'
